...
*/
function loadLessQuantityList(){
	
	$.get(" lessQuantityProducts.html", function(result){
		
		$(".lessQuantityList").html(result);
	});
...
<body>
 ...
 <!--Horizontal Tab-->
        <div id="horizontalTab">
            ...
            <li onclick=""><a style="color: #3C873C;" href="expiryProducts.html">Move To Going to expire products list</a> </li>
            
                <li onclick="loadLessQuantityList();" class="activemode" style="color: #fff;border-color: #3C873C;">Less quantity products list</li>
            ...
            <div class="resp-tabs-container">
              <div>
                ...
                <div  class="lessQuantityList">
                   <p><jsp:include page="/WEB-INF/views/product/list/lessQuantityProductsList.jsp"></jsp:include></p>
 				</div>
