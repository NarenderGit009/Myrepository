...
function loadExpiryProducts(){
	...
	$.get("expiryProducts.html", function(result){
		...
		$(".expiryProductsList").html(result);
		});
...
<body>
 ...
 <!--Horizontal Tab-->
        <div id="horizontalTab">
            ...
            <li onclick="loadExpiryProducts();" class="activemode" style="color: #fff;border-color: #3C873C;">Going to expire products list</li>
            <li ><a style="color: #3C873C;" href="lessQuantityProducts.html">Move To less Quantity Products List</a></li>
                              
               
            </ul>
            <div class="resp-tabs-container">
                <div class="expiryProductsList">
                   <p><jsp:include page="/WEB-INF/views/product/list/goingToExpireProductsList.jsp"></jsp:include></p>
 				</div>
