...
<script src="js/menu/easing.min.js"></script>
 ...
 <c:if test='${user.id=="1"}'>
   ...
   <li class="Masters"><a href='#'>Masters</a>
      <ul>
         <li><a href='productEntryForm.html?task_form_type=medical'> Product Stock Entry </a></li>
         <li><a href='#'> Products Upload </a></li>
         <li><a href='#'> Revenue Accounts </a></li>
         <li><a href='openBranchFrom1.html?uid=${sessionScope.user.id}'> Register Branch </a></li>
         <li><a href='doctorForm.html?uid=${sessionScope.user.id}'> Register Doctor </a></li>
         <li class='last'><a href='agencyForm.html?uid=${sessionScope.user.id}'> Register Agency </a></li>
   ...
   <li class="Reports"><a href='#'>Reports</a>
    ...
    <li class="Lists"><a href='#'>Lists</a>
        <ul>
         ...
         <li><a href='agenciesList.html?uid=${sessionScope.user.id}'> Agencies List </a></li>
         <li><a href='doctorsList.html?uid=${sessionScope.user.id}'> Doctors List </a></li>
