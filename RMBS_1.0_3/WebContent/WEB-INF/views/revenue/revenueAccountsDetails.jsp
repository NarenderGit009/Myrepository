...
<c:set value="${PreSales}" var="presale"></c:set>
		...
		<c:if test="${orderType == purchase}">
		<h2 align="center" class="listcaption">Purchase Revenue Accounts based on the duration</h2>		
		</c:if>
		
		<c:if test="${orderType == sale}">
		<h2 align="center" class="listcaption">Sales Revenue Accounts based on the duration</h2>		
		</c:if>
		
		<c:if test="${orderType == presale}">
		<h2 align="center" class="listcaption">Pre Sales Revenue Accounts based on the duration</h2>		
		</c:if>
