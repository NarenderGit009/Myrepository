...
<title>Insert title here</title>
	...
	//${sessionScope.user.id}
		...
		$(function() {		
			 ...
			 $.get('damagedProducts.html',function(result){
       		  if(result!=null){
       			
       			  $('#damaged_products').html(result);
...
<body onload="">
   ...
   <%--  <li><a class=".damaged_products">Damaged Products</a></li> --%>    
                <li><a>Pre orders</a></li>
                <li><a>Offers</a></li>
                <li><a>Mails</a></li>
                <li><a>Messages</a></li>
            </ul>
            <div class="resp-tabs-container">
         <%-- <div id="damaged_products">
