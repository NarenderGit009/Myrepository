...
@Service
public class PurchaseOrderListDownloadService {

	public static final String TEMPLATE = "/purchaseOrderListReports.jrxml";
	...
	public void download(String type, String token, HttpServletResponse response, PurchaseOrderModel purchaseOrderModel) {
		 
		try {
			// 1. Add report parameters
			HashMap<String, Object> params = new HashMap<String, Object>(); 
			params.put("Title", "Purchse Reports");
			String fileName = "Purchse Reports";
		...
		//	JRDataSource jrd = new JRBeanCollectionDataSource(list);
			...
			JasperPrint jp = JasperFillManager.fillReport(jr, params,reportsService.purchaseOrderListReports(purchaseOrderModel));
