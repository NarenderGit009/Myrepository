...
@Service
public class MasterProductsDownloadService {

	public static final String TEMPLATE = "/masterProductReports.jrxml";
	...
	public void download(String type, String token, HttpServletResponse response) {
		...
		try {
			...
			params.put("Title", "Master Product List");
			String fileName = "Master Product List";
			...
			JasperPrint jp = JasperFillManager.fillReport(jr, params, reportsService.retrieveAllExistedProucts());
