...
public class ProductStockDownloadService {
	...
	public void download(String type, String token, HttpServletResponse response,int branchId) {
		...
		try {
			...
			JasperPrint jp = JasperFillManager.fillReport(jr, params, reportsService.productStockListBybranch(branchId));
