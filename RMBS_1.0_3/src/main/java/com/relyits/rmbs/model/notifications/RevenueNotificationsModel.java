...
@Entity
@Table(name="RMBS702", schema="RMBS",
            uniqueConstraints = {
		           @UniqueConstraint(columnNames = "RMBS70201") })   //id
public class RevenueNotificationsModel implements Serializable {
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name = "RMBS70201", unique = true, nullable = false)
	private Integer id;
	
	@Column(name = "RMBS70202", nullable = false, length = 100)
	private String message;
	
	@Column(name = "RMBS70203", nullable = false, length = 100)
	private Double amount;
	
	@Column(name = "RMBS70204", nullable = false, length = 25)
	...
	@Column(name = "RMBS70205", nullable = false, length = 100)
